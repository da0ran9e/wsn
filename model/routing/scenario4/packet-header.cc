...
NS_LOG_COMPONENT_DEFINE("Scenario4PacketHeader");
...
{
    static TypeId tid = TypeId("ns3::wsn::scenario4::routing::PacketHeader")
        .SetParent<Header>()
        .SetGroupName("Wsn")
...
{
    static TypeId tid = TypeId("ns3::wsn::scenario4::routing::StartupPhasePacket")
        .SetParent<Header>()
        .SetGroupName("Wsn")
...
{
    static TypeId tid = TypeId("ns3::wsn::scenario4::routing::FragmentPacket")
        .SetParent<Header>()
        .SetGroupName("Wsn")
...
{
    static TypeId tid = TypeId("ns3::wsn::scenario4::routing::CooperationPacket")
        .SetParent<Header>()
        .SetGroupName("Wsn")

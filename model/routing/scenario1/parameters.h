 ...
 *
 * Scenario1 Parameters: Central configuration for scenario simulation
 */

#ifndef SCENARIO1_PARAMETERS_H
#define SCENARIO1_PARAMETERS_H
...
struct GroundNetworkParams
{
    ...
    // Timing parameters
    static constexpr double DEFAULT_SIM_TIME = 8.0;                  // seconds
...
{
    // Altitude
    static constexpr double DEFAULT_ALTITUDE = 10.0;                 // meters

...
GenerateFragments(uint32_t numFragments)
{
    ...
    const uint32_t masterFileSize = ::ns3::wsn::scenario5::params::DEFAULT_MASTER_FILE_SIZE_BYTES;
    const double masterFileConfidence = ::ns3::wsn::scenario5::params::DEFAULT_MASTER_FILE_CONFIDENCE;
    const double weightMin = ::ns3::wsn::scenario5::params::FRAGMENT_WEIGHT_MIN;
    const double weightMax = ::ns3::wsn::scenario5::params::FRAGMENT_WEIGHT_MAX;
